...
rename propertyid ListCountAll
label var ListCountAll "Number of listings per host per day (active and inactive)"
save "Y:\agrajg\Research\Data\temp\010209_HostTime_PropCountAll.dta", replace
...
encode tempvar, generate(HostType1All)
drop tempvar
label var HostType1All "Host type 1 using all properties"
save "Y:\agrajg\Research\Data\temp\010209_Host_HostType1All.dta", replace
restore
...
drop if status=="B"
collapse (count)propertyid, by (hostid date)
rename propertyid ListCountActive
label var ListCountActive "Number of listings per host per day (active)"
save "Y:\agrajg\Research\Data\temp\010209_HostTime_PropCountActive.dta", replace
...
encode tempvar, generate(HostType1Active)
drop tempvar
label var HostType1Active "Host type 1 using active properties"
save "Y:\agrajg\Research\Data\temp\010209_Host_HostType1Active.dta", replace
restore
*-------------------------------------------------------------------------------
