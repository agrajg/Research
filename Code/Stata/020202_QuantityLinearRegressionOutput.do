...
*-------------------------------------------------------------------------------
cap erase Y:\agrajg\Research\Output\020202_QuantityLinearRegressionOutput.txt
cap erase Y:\agrajg\Research\Output\020202_QuantityLinearRegressionOutput.xml
cap erase Y:\agrajg\Research\Output\020202_QuantityLinearRegressionOutput.tex
forval i=0(1)0 {
	forval j=0(1)8{
		forval k=1(1)8{
			forval l=1(1)2{
				estimates use "Y:\agrajg\Research\Output\020201_sdum3_`i'`j'`k'`l'.ster"
				outreg2 using "Y:\agrajg\Research\Output\020202_QuantityLinearRegressionOutput", 	cttop(`i'`j'`k'`l')
			}
		}
	}
}
estimates use "Y:\agrajg\Research\Output\020201_sdum3_0882.ster"
outreg2 using "Y:\agrajg\Research\Output\020202_QuantityLinearRegressionOutput", 	cttop(0882) ///
																					tex excel ///
																					sortvar( ///
																						T_RegPurgeDum ///
																						T_RegDataDiscDum ///
