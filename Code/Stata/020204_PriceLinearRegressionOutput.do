...
global X_HT HT_HostAge HT_HostAgeComb HT_Adayshost	count HT_Bdayshostcount HT_Rdayshostcount HT_HostGuestPastCount
global Z_LT LT_PropAge LT_Adayscount LT_Bdayscount LT_Rdayscount LT_PropGuestPastCount
*-------------------------------------------------------------------------------
cap erase Y:\agrajg\Research\Output\020204_PriceLinearRegressionOutput.txt
cap erase Y:\agrajg\Research\Output\020204_PriceLinearRegressionOutput.xml
cap erase Y:\agrajg\Research\Output\020204_PriceLinearRegressionOutput.tex

forval i=0(1)0 {
	forval j=0(1)8{
		forval k=1(1)8{
			forval l=1(1)2{
				estimates use "Y:\agrajg\Research\Output\020203_lprice_`i'`j'`k'`l'.ster"
				outreg2 using "Y:\agrajg\Research\Output\020204_PriceLinearRegressionOutput", 	cttop(`i'`j'`k'`l')
			}
		}
	}
}

estimates use "Y:\agrajg\Research\Output\020203_lprice_0882.ster"
outreg2 using "Y:\agrajg\Research\Output\020204_PriceLinearRegressionOutput", 	cttop(0882) ///
																				tex excel ///
																				sortvar ( ///
																					T_RegPurgeDum  ///
																					T_RegDataDiscDum ///
