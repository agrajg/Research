...
local i=1
	cap erase Y:\agrajg\Research\Output\020210_PriceLinearRegressionOutput_set_`i'.txt
	cap erase Y:\agrajg\Research\Output\020210_PriceLinearRegressionOutput_set_`i'.xml
	cap erase Y:\agrajg\Research\Output\020210_PriceLinearRegressionOutput_set_`i'.tex
	forval j=1(1)24{
		estimates use "Y:\agrajg\Research\Output\020208_lprice_`j'_set_`i'.ster"
		outreg2 using "Y:\agrajg\Research\Output\020210_PriceLinearRegressionOutput_set_`i'", 	cttop(Reg `j' Set `i') 
	}
estimates use "Y:\agrajg\Research\Output\020208_lprice_25_set_`i'.ster"
outreg2 using "Y:\agrajg\Research\Output\020210_PriceLinearRegressionOutput_set_`i'", 	cttop(Reg `j' Set `i') ///
																					tex excel 
