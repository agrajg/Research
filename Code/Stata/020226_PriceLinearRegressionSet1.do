...
*-------------------------------------------------------------------------------
xtreg lprice INT2W* INT3W* $x_HT $z_HLT $t_T, fe
estimates save "Y:\agrajg\Research\Output\020226_lprice_stage1_reg3", replace
preserve
...
keep if _merge ==3
drop _merge 
save "Y:\agrajg\Research\Data\temp\020226_lprice_stage1_reg3_TimeFE.dta", replace
...
estimates save "Y:\agrajg\Research\Output\020226_lprice_stage2_reg3", replace
restore
*-------------------------------------------------------------------------------
*-------------------------------------------------------------------------------
preserve
xtreg lprice $x_HT $z_HLT $t_T, fe
estimates save "Y:\agrajg\Research\Output\020226_lprice_stage1_reg1", replace
...
keep if _merge ==3
drop _merge 
save "Y:\agrajg\Research\Data\temp\020226_lprice_stage1_reg1_TimeFE.dta", replace

reg meantimeFE T_RegPurgeDum T_RegDataDiscDum T_RegActRegImpDum i.T_year i.T_dom i.T_dow i.T_wom2 i.T_holiday i.T_holidaywom2
estimates save "Y:\agrajg\Research\Output\020226_lprice_stage2_reg1", replace
restore
*-------------------------------------------------------------------------------
*-------------------------------------------------------------------------------
preserve
xtreg lprice INT2W* $x_HT $z_HLT $t_T, fe
estimates save "Y:\agrajg\Research\Output\020226_lprice_stage1_reg2", replace
...
keep if _merge ==3
drop _merge 
save "Y:\agrajg\Research\Data\temp\020226_lprice_stage1_reg2_TimeFE.dta", replace

reg meantimeFE T_RegPurgeDum T_RegDataDiscDum T_RegActRegImpDum i.T_year i.T_dom i.T_dow i.T_wom2 i.T_holiday i.T_holidaywom2
estimates save "Y:\agrajg\Research\Output\020226_lprice_stage2_reg2", replace
restore
*-------------------------------------------------------------------------------
