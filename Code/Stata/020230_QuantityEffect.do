...
*-------------------------------------------------------------------------------
// preserve
xtreg sdum3 T_RegPurgeDum T_RegCalledIllegal T_RegDebate T_RegRedSupply  T_RegDataDiscDum T_RegActRegImpDum $x_HT $z_HLT $s_T, fe
estimates save "Y:\agrajg\Research\Output\020230_QuantityEffect_Spec2", replace
// restore
*-------------------------------------------------------------------------------
