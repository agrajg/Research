...
import delimited Y:\agrajg\Research\Output\HedonicRegressionsAllSpecificationsAllperiodAbsorb.txt
...
gen coeffltypedum1_hat=_b[time1]*time1+_b[time2]*0+_b[time3]*0+_b[time4]*time4+_b[time5]*time5+_b[time6]*time6+_b[time7]*0+_b[time8]*time8+_b[time9]*0+_b[time10]*time10
ereturn list
*plot
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsAllSpecificationsAllperiodAbsorb_coeffltypedum1.png", as(png) replace width(1300) height(800)
********************************************************************************
reg coeffltypedum4 time* i.year i.moy i.holidaywom2 i.dow i.holiday 
gen coeffltypedum4_hat=_b[time1]*time1+_b[time2]*time2+_b[time3]*time3+_b[time4]*time4+_b[time5]*time5+_b[time6]*0+_b[time7]*time7+_b[time8]*0+_b[time9]*time9+_b[time10]*time10
ereturn list
*plot
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsAllSpecificationsAllperiodAbsorb_coeffltypedum4.png", as(png) replace width(1300) height(800)
********************************************************************************
reg coeffbedrooms time* i.year i.moy i.holidaywom2 i.dow i.holiday 
gen coeffbedrooms_hat=_b[time1]*0+_b[time2]*time2+_b[time3]*time3+_b[time4]*time4+_b[time5]*time5+_b[time6]*time6+_b[time7]*time7+_b[time8]*time8+_b[time9]*time9+_b[time10]*0
ereturn list
*plot
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsAllSpecificationsAllperiodAbsorb_coeffbedrooms.png", as(png) replace width(1300) height(800)
********************************************************************************
reg coeffbathrooms time* i.year i.moy i.holidaywom2 i.dow i.holiday 
gen coeffbathrooms_hat=_b[time1]*0+_b[time2]*time2+_b[time3]*time3+_b[time4]*time4+_b[time5]*time5+_b[time6]*time6+_b[time7]*time7+_b[time8]*time8+_b[time9]*time9+_b[time10]*time10
ereturn list
*plot
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsAllSpecificationsAllperiodAbsorb_coeffbathrooms.png", as(png) replace width(1300) height(800)
********************************************************************************

keep date coeffr2_a 
rename coeffr2_a HRBaseDistAll_r2_a
save "Y:\agrajg\Research\Output\HedonicRegressionsAllSpecificationsAllperiodAbsorb_r2_a", replace
exit, clear
