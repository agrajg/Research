...
gen coeffbathrooms_hat=_b[time1]*time1+_b[time2]*time2+_b[time3]*0+_b[time4]*time4+_b[time5]*time5+_b[time6]*time6+_b[time7]*time7+_b[time8]*time8+_b[time9]*time9+_b[time10]*time10
ereturn list
*plot
...
keep date coeffr2_a 
rename coeffr2_a HedonicRegressionsBase_r2_a
save "Y:\agrajg\Research\Output\HedonicRegressionsBase_r2_a", replace
exit, clear
