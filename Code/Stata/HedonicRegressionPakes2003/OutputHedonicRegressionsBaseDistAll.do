...
import delimited Y:\agrajg\Research\Output\HedonicRegressionsBaseDistAll.txt
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsBaseDistAll_coeffltypedum1.png", as(png) replace width(1300) height(800)
********************************************************************************
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsBaseDistAll_coeffltypedum4.png", as(png) replace width(1300) height(800)
********************************************************************************
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsBaseDistAll_coeffbedrooms.png", as(png) replace width(1300) height(800)
********************************************************************************
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsBaseDistAll_coeffbathrooms.png", as(png) replace width(1300) height(800)
********************************************************************************

keep date coeffr2_a 
rename coeffr2_a HRBaseDistAll_r2_a
save "Y:\agrajg\Research\Output\HedonicRegressionsBaseDistAll_r2_a", replace
exit, clear
