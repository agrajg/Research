...
import delimited Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2NbhdAll.txt
...
gen coeffltypedum1_hat=_b[time1]*0+_b[time2]*time2+_b[time3]*0+_b[time4]*time4+_b[time5]*0+_b[time6]*time6+_b[time7]*0+_b[time8]*0+_b[time9]*0+_b[time10]*0
ereturn list
*plot
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsBasePlus2NbhdAll_coeffltypedum1.png", as(png) replace width(1300) height(800)
********************************************************************************
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsBasePlus2NbhdAll_coeffltypedum4.png", as(png) replace width(1300) height(800)
********************************************************************************
reg coeffbedrooms time* i.year i.moy i.holidaywom2 i.dow i.holiday 
gen coeffbedrooms_hat=_b[time2]*time2
ereturn list
*plot
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsBasePlus2NbhdAll_coeffbedrooms.png", as(png) replace width(1300) height(800)
********************************************************************************
...
graph export "Y:\agrajg\Research\Output\Graphs\HedonicRegressionsBasePlus2NbhdAll_coeffbathrooms.png", as(png) replace width(1300) height(800)
********************************************************************************

keep date coeffr2_a 
rename coeffr2_a HRBaseDistAll_r2_a
save "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2NbhdAll_r2_a", replace
exit, clear
