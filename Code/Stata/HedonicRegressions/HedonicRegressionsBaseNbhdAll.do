...
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBaseNbhdAll", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms nbhddum*) e(all)
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBaseNbhdAll", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms nbhddum*) e(all)
...
forvalues i = `dateminplus1'(1)`datemaxminus1' {
	...
	global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
	regress lprice ltypedum* bedrooms bathrooms nbhddum* $OtherCovariates
    outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBaseNbhdAll", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms nbhddum*) e(all)
	*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBaseNbhdAll", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms nbhddum*) e(all)
}
di "loop at " `datemax'
di "======================>"
...
global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
regress lprice ltypedum* bedrooms bathrooms nbhddum* $OtherCovariates
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBaseNbhdAll", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms nbhddum*) e(all) see excel dta 
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBaseNbhdAll", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms nbhddum*) e(all) see excel tex dta 
