...
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2All", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms bedXbath bedXltypedum*) e(all)
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus2All", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms) e(all)
...
forvalues i = `dateminplus1'(1)`datemaxminus1' {
	...
	global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
	regress lprice ltypedum* bedrooms bathrooms bedXbath bedXltypedum* $OtherCovariates
    outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2All", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms bedXbath bedXltypedum*) e(all)
	*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus2All", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms) e(all)
}
di "loop at " `datemax'
di "======================>"
...
global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
regress lprice ltypedum* bedrooms bathrooms bedXbath bedXltypedum* $OtherCovariates
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2All", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms bedXbath bedXltypedum*) e(all) see excel dta 
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus2All", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms) e(all) see excel tex dta 
