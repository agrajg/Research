...
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2DistAll", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms bedXbath bedXltypedum* dist*) e(all)
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus2DistAll", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms) e(all)
...
forvalues i = `dateminplus1'(1)`datemaxminus1' {
	...
	global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
	regress lprice ltypedum* bedrooms bathrooms bedXbath bedXltypedum* dist* $OtherCovariates
    outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2DistAll", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms bedXbath bedXltypedum* dist*) e(all)
	*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus2DistAll", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms) e(all)
}
di "loop at " `datemax'
di "======================>"
...
global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
regress lprice ltypedum* bedrooms bathrooms bedXbath bedXltypedum* dist* $OtherCovariates
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2DistAll", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms bedXbath bedXltypedum* dist*) e(all) see excel dta 
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus2DistAll", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms) e(all) see excel tex dta 
