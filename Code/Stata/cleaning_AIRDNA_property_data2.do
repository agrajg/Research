...
******** SAVING A COPY OF DIRTY DATA *******************************************
	...
	* ==============================================================================
	save "Y:\agrajg\Research\Data\AIRDNA_listings_dta_data\AIRDNA_listings_dta_dirty.dta", replace
	* ==============================================================================
...
* ==============================================================================
use "Y:\agrajg\Research\Data\RawMCOX_listings_dta_data\MCOX_property_data_clean1.dta" , clear
* ==============================================================================
...
preserve
	...
	* ==============================================================================
	use "Y:\agrajg\Research\Data\AIRDNA_market_dta_data\AIRDNA_market_data_clean_final.dta", clear
	* ==============================================================================
