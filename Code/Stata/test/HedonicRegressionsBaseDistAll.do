...
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBaseDistAll", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms dist*) e(all)
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBaseDistAll", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms dist*) e(all)
...
forvalues i = `dateminplus1'(1)`datemaxminus1' {
	...
	global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
	regress lprice ltypedum* bedrooms bathrooms dist* $OtherCovariates
    outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBaseDistAll", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms dist*) e(all)
	*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBaseDistAll", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms dist*) e(all)
}
di "loop at " `datemax'
di "======================>"
...
global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
regress lprice ltypedum* bedrooms bathrooms dist* $OtherCovariates
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBaseDistAll", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms dist*) e(all) see excel dta 
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBaseDistAll", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms dist*) e(all) see excel tex dta 
