...
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus1", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms bedXbath) e(all)
...
forvalues i = `dateminplus1'(1)`datemaxminus1' {
	...
	gen bedXbath = bedrooms * bathrooms
	regress lprice ltypedum* bedrooms bathrooms bedXbath
    outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus1", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms bedXbath) e(all)
...
gen bedXbath = bedrooms * bathrooms
regress lprice ltypedum* bedrooms bathrooms bedXbath
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus1", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms bedXbath) e(all) see excel dta 
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBase", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms) e(all) see excel tex dta 
