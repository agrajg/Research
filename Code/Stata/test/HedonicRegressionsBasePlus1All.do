...
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus1All", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms bedXbath) e(all)
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus1All", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms) e(all)
...
forvalues i = `dateminplus1'(1)`datemaxminus1' {
	...
	global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
	regress lprice ltypedum* bedrooms bathrooms bedXbath $OtherCovariates
    outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus1All", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms bedXbath) e(all)
	*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus1All", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms) e(all)
}
di "loop at " `datemax'
di "======================>"
...
global OtherCovariates prtyprdum* age maxguests responserate responsetimemin chintimedum* checkinperiod chouttimedum* minimumstay instbookdum*
regress lprice ltypedum* bedrooms bathrooms bedXbath $OtherCovariates
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus1All", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms bedXbath) e(all) see excel dta 
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus1All", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms) e(all) see excel tex dta 
