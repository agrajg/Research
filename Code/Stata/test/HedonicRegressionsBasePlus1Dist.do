...
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus1Dist", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms bedXbath dist*) e(all)
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus1Dist", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms) e(all)
...
forvalues i = `dateminplus1'(1)`datemaxminus1' {
	...
	gen bedXbath = bedrooms * bathrooms
	regress lprice ltypedum* bedrooms bathrooms bedXbath dist*
    outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus1Dist", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms bedXbath dist*) e(all)
	*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus1Dist", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms) e(all)
}
di "loop at " `datemax'
di "======================>"
...
gen bedXbath = bedrooms * bathrooms
regress lprice ltypedum* bedrooms bathrooms bedXbath dist*
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus1Dist", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms bedXbath dist*) e(all) see excel dta 
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus1Dist", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms) e(all) see excel tex dta 
