...
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2Nbhd", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms bedXbath bedXltypedum* nbhddum*) e(all)
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus2Nbhd", replace side cttop(`datemin') sortvar(ltypedum* bedrooms bathrooms) e(all)
...
forvalues i = `dateminplus1'(1)`datemaxminus1' {
	...
	gen bedXltypedum4 = ltypedum4 * bedrooms
	regress lprice ltypedum* bedrooms bathrooms bedXbath bedXltypedum* nbhddum*
    outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2Nbhd", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms bedXbath bedXltypedum* nbhddum*) e(all)
	*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus2Nbhd", side cttop(`i') sortvar(ltypedum* bedrooms bathrooms) e(all)
}
di "loop at " `datemax'
di "======================>"
...
gen bedXltypedum4 = ltypedum4 * bedrooms
regress lprice ltypedum* bedrooms bathrooms bedXbath bedXltypedum* nbhddum*
outreg2 using "Y:\agrajg\Research\Output\HedonicRegressionsBasePlus2Nbhd", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms bedXbath bedXltypedum* nbhddum*) e(all) see excel dta 
*outreg2 using "Y:\agrajg\Research\Output\Par\HedonicRegressionsBasePlus2Nbhd", side cttop(`datemax') sortvar(ltypedum* bedrooms bathrooms) e(all) see excel tex dta 
